...
public class FattyGroundTool : EditorWindow
{
    ...
    static bool PrefabFilter()
    {
        ...
        //return PrefabUtility.GetPrefabType(go) == PrefabType.Prefab || PrefabUtility.GetPrefabType(go) == PrefabType.ModelPrefab; //2017
        return PrefabUtility.IsPartOfAnyPrefab(go) && PrefabUtility.GetPrefabInstanceStatus(go) == PrefabInstanceStatus.NotAPrefab;  //2018
    }
